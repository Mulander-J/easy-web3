...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) payable ERC721("SSR Name Service", "SSR") {
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the SSR name service", "image": "data:image/svg+xml;base64,',
  ...
  function setRecord(string calldata name, string calldata record) public {
      // require(domains[name] == msg.sender, "Name doesnt match sender");
